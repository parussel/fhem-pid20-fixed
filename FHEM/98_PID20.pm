# $Id: 98_PID20.pm 29517 2026-05-16 04:48:00Z parussel $
...
sub PID20_Calc($)
{
  ...
  while (1)
  {
    ...
    if ($calcReq)
    {
      ...
      # calc d-Portion (NUTZT JETZT DEN KORRIGIERTEN GRADIENTEN)
...
<h3>PID20</h3>
<ul>
  <p><b>Note:</b> This repository contains the community-fixed version (V 1.0.0.13) which fixes the sign inversion bug of the D-portion when <code>pidReverseAction</code> is activated.</p>
